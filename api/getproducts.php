...
$url = "http://wtdusaonline.com/DesktopModules/AutoBiz_Vault/API/ProductListing/GetProducts";
$username = $email."-96";
$password = $pass;
...
if (isset($_REQUEST['mail'])) {
	...
	$url = "http://wtdusaonline.com/DesktopModules/AutoBiz_Vault/API/ProductListing/PlaceOrder?OrderCatalogs=".$catalog."&OrderQuantities=".$qty;
	$username = $email."-96";
	$password = $pass;
