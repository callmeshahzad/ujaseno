        ...
        <div class="content-wrapper full-left">
            ...
            <div class="middle-wrapper">
                <div class="bread-crumb noprint">
                    <a href="#">Home</a>
                    <a href="history.php" class="bread-crumb-active"> Order History</a>
                ...
                <div class="content-container unsubmitted-order-container">
                    ...
                    <div class="unsubmitted-order">
                        <table id="unsubmitted-order-entries">
                            ...
                            $query = "SELECT * FROM tbl_order_detail WHERE order_id='$orderID'";
                            ...
                            if($result->num_rows > 0 ){
                                while ($row = $result->fetch_object()){
                                    ...
                                    <tr>
                                        <td><?=$row->catalog?></td>
                                        <td><?=$row->qty?></td>
                                        <td style="font-weight: bold">$<?=$row->single_price?></td>
                                        <td style="font-weight: bold">$<?=$row->total_qty_price?></td>
                                    </tr>
