...
<meta charset=utf-8>
<title>WTD | Term & Conditions</title>
...
<<<<<<< HEAD
                    <svg data-v-c0b305c2 viewBox="0 0 4011 515" preserveAspectRatio="xMinYMid slice" class=hero-mask>
                        <defs>
                ...
                <div data-v-c0b305c2 class=text-container>
                    <div data-v-c0b305c2 class=titles-container>
                        <div data-v-c0b305c2 class=black>
                            <div class=line style=display:block;text-align:right;position:relative;transform:matrix(1,0,0,1,0,0)></div>
                        </div> 
...
=======
                    <svg data-v-c0b305c2 viewBox="0 0 4011 515" preserveAspectRatio="xMinYMid slice" class=hero-mask><defs><path id=a d="M0 0h4011v515H0z" class=path-1></path></defs><g fill=none fill-rule=evenodd><mask id=b fill=#fff><use xlink:href=#a></use></mask><g mask=url(#b)><g transform="translate(0 -437)"><circle stroke=#E1EBF4 stroke-width=529 cx=1283 cy=809 r=809 class=circle style=stroke-dasharray:0,999999px;stroke-dashoffset:5084.1></circle><circle stroke=#FFF stroke-width=529 cx=1283 cy=809 r=809 class=circle-white style=stroke-dasharray:1e-05px,5094.1px;stroke-dashoffset:0></circle><path d="M880.604 437h804.792C1775.771 534.712 1831 665.406 1831 809c0 49.11-6.46 96.711-18.577 142H753.577C741.46 905.711 735 858.11 735 809c0-143.594 55.229-274.288 145.604-372zm-601.167 0C236.473 552.863 213 678.19 213 809c0 48.142 3.18 95.542 9.34 142H0V437h279.437zm2007.126 0H4011v514H2343.66c6.16-46.458 9.34-93.858 9.34-142 0-130.81-23.473-256.137-66.437-372zM1165 437h2846v515H1165V437z" fill=#E1EBF4 fill-rule=nonzero class=path-2></path></g></g></g></svg></div> <div data-v-c0b305c2 class=common-center-container><div data-v-c0b305c2 class=text-container><div data-v-c0b305c2 class=titles-container><div data-v-c0b305c2 class=black><div class=line style=display:block;text-align:right;position:relative;transform:matrix(1,0,0,1,0,0)></div></div> <div data-v-c0b305c2 class=blue><div class=line style=display:block;text-align:right;position:relative;transform:matrix(1,0,0,1,0,0)>  </div></div></div> <h3 data-v-c0b305c2 class=subheading><div class=line style=display:block;text-align:right;position:relative;transform:matrix(1,0,0,1,0,0);font-size:3vw>  Terms and conditions</div></h3></div></div></div>
>>>>>>> a82aea4cc420f56865ef7a8f9a5149a16a2bbf38
                ...
                <div data-v-191b6ba8 class=common-center-container>
                    <div data-v-191b6ba8 class=content-container>
                        <div data-v-191b6ba8 class=jobs-container>
                            <!--<h2 class="paragraf-font-heading">These terms and conditions</h2>-->
                            <p class="paragraf-font-size">WTD USA does not provide warranty on shaved white wall tires. WTD USA will not be held liable for any damages that may occure to you or your vehicle due to spoke rims, low profile tires, or shaved tires. Low profile tires or any 25, 30, 55 series are not warrantied stated otherwise, One year manufacturing warranty on wheels and tires.No return of any product after 30 days of purchase.Returned product within 30 days must be its orignal packing( i.e plastic cover, rim guard, dust protector), mounted tires without label or mounted wheels will not be returned. Return can only be made after contacting the sales Rep of WTD USA. All sales are final. No cash refunds. customer will pay additional 2.6% when they used credit cards for payments. customer agreed that all purchases must be paid within 30days of purchase, unless other term are agreed between customer & authorized officer of WTD USA(should be in written contract).if litigation is commenced to collect payment on any open invoices, purchaser/customer agrees to pay the Attorney fees and cost of litigation or collection. customer agrees that merchandise not paid in 30days or agreed terms, will be charged interest of 1.5% per month. not exceeding 18% per year. any NSF checks will be charged a return fee of $35 per NSF check. In case of two NSF in 10days or three NSF in a month, WTD USA has the right to change the terms on your account (it would be cash only or hold the account).( WTD USA RESERVE THE RIGHT TO REFUSE ANY INCORRECT PRICE GIVEN DUE TO HUMAN ERRORS OR DUE TO SOFTWARE ERRORS). WE APPRECIATE YOUR BUSINESS WITH US.</p> <br />
                            ...
                            <!--<p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use WTD's website-->
                            ...
                            <!--<h2>Cookies</h2>-->
                            <!--<p>We employ the use of cookies. By using WTD's website you consent to the use of cookies-->
                            <!--    in accordance with WTD’s privacy policy.</p><p>Most of the modern day interactive web sites-->
                            <!--    use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site-->
                            <!--    to enable the functionality of this area and ease of use for those people visiting. Some of our-->
                            <!--    affiliate / advertising partners may also use cookies.</p><h2>License</h2>-->
                            <!--<p>Unless otherwise stated, WTD and/or it’s licensors own the intellectual property rights for-->
                            <!--    all material on WTD. All intellectual property rights are reserved. You may view and/or print-->
                            <!--    pages from http://esspk.net/production/wtd/ for your own personal use subject to restrictions set in these terms and conditions.</p>-->
                            <!--<p>You must not:</p>-->
                            <!--<ol>-->
                            <!--    <li>Republish material from http://esspk.net/production/wtd/</li>-->
                            <!--    <li>Sell, rent or sub-license material from http://esspk.net/production/wtd/</li>-->
                            <!--    <li>Reproduce, duplicate or copy material from http://esspk.net/production/wtd/</li>-->
                            <!--</ol>-->
                            <!--<p>Redistribute content from WTD (unless content is specifically made for redistribution).</p>-->
                            ...
                            <!--    you must notify us by sending an e-mail to <a href="mailto:waseem@wtdusonline.com" title="send an email to waseem@wtdusonline.com">waseem@wtdusonline.com</a>.-->
                            ...
                            <!--</ol>-->
                            <!--<p>No use of WTD’s logo or other artwork will be allowed for linking absent a trademark license-->
                            <!--    agreement.</p>-->
                            <!--<h2>Iframes</h2>-->
