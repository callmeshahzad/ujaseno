...
<div class="content-wrapper full-left top-header-margin"> 
 ...
 <div class="middle-wrapper" style="padding-left:12px; padding-top:0px;"> 
    ...
    <?php
        ...
        if (isset($_GET['search'])&&isset($_GET['WheelWidth'])&&isset($_GET['WheelBoltCircle'])&&isset($_GET['imid'])) {
            $temp=explode('=',$_GET['search']);
            $wheeldiameter=$temp[1];
            $urlWheel = "https://wtd-api-helper.herokuapp.com/api?wheeldiameter=".$wheeldiameter."&wheelwidth=".$_GET['WheelWidth']."&wheelboltcircle=".$_GET['WheelBoltCircle']."&imid=".$_GET['imid']."";
            try {
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <p class="size">Manufacturer:</p>
                            </div>
                            <div class="col-md-3">
                                <p class="size"><?=$result['size']?></p>
                                <p class="size"><?=$result['catalog']?></p>
                                <p class="size"><?=$result['description']?></p>
                                <p class="size">
                                    <?php
                        ...
                        <?php
                            if((int)$result['avail1121420'] > 0){
                            ?>
                            <div class="add-to-cart-div text-center pull-left "> 
                                <span class="qty-content" id="add-to-cart-section-3842693"> 
                                    <input type="text" style="height:34px !important;margin-top:0px !important"  placeholder="Qty" class="inputQuantity<?=$rand?>" name="quantity" id="<?=$result['catalog']?>,<?=$result['price']?>" data-id="<?=$rand?>" avail="<?=$result['avail1121420']?><?php echo $pp ?>"  />
                                </span> 
                                <button class="btn" id="add-to-cart-button<?=$rand?>" onclick="addToCart('<?=$rand?>');" > Add to cart </button>
