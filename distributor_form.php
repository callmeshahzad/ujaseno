...
<div data-v-68d9be01 data-v-5ff8ac3c id=form-section class=component-FormSection style="!important; padding:20px; background:url(img/action-adult-auto-2127038.jpg)">
...
?>
        <div class="row" >
            <form id=contact-form action="submitform.php" method="post" style="color: #ffffff;" name="distributerForm" onsubmit="return validateCaptcha();">
                <div class="col-sm-6">
                ...
                <div class="col-sm-12 row">
                    <div class="col-sm-3 center-block" style="float: none;">
                        <!-- <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div id="captcha">
                             ...
                             <input type="text" placeholder="Captcha" id="cpatchaTextBox" class="form-control"/>
                                ...
                                <button class="btn btn-default" type="button" onclick="createCaptcha()">
                        ...
                        <div class="form-group" align="center">
                            <button type="submit" class="btn btn-primary" style="bottom: 15px;width: 100%;background: red;border: red; font-weight:bold">SUBMIT</button>
                        </div>
                    </div>
                </div>
