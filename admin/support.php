...
include('support/database_connection.php');
include('header.php');
...
<div class="content">
    <div class="container-fluid">
        <br>
        <hr>
        <h3 align="center"><a href="#">Live Chat Support</a></h3><br />
            <br />
            <div class="row">
...
<div id="group_chat_dialog" title="Group Chat Window">
    ...
    <div class="form-group" align="right">
        <button type="button" name="send_group_chat" id="send_group_chat" class="btn btn-info" onkeydown="sendChat()">Send</button>
    </div>
</div>
...
$(document).ready(function(){
    ...
    {
        $.ajax({
            url:"support/update_last_activity.php",
            success:function()
            {
    ...
    function make_chat_dialog_box(to_user_id, to_user_name)
    {
        ...
        modal_content += '<div style="height:300px; border:0px solid #ccc; overflow-y: scroll; margin-bottom:10px; padding:10px;" class="chat_history" data-touserid="'+to_user_id+'" id="chat_history_'+to_user_id+'">';
    ...
    {
        $.ajax({
            url:"support/fetch_user_chat_history.php",
            method:"POST",
            data:{to_user_id:to_user_id},
            success:function(data){
                $('#chat_history_'+to_user_id).html(data);
    ...
    $(document).on('focus', '.chat_message', function(){
        var is_type = 'yes';
        $.ajax({
            url:"support/update_is_type_status.php",
            method:"POST",
