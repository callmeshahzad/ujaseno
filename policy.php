...
<meta charset=utf-8>
<title>WTD | Privacy Policy</title>
...
<div id=app class=english>
    ...
    <div data-v-0b5d6b6e class="component-Careers vue-router-section" lang=en style=visibility:inherit;opacity:1>
        <div class="logo" style="position:absolute;top:0px;left:34%;width: 250px;"><a href="index.php"><img src="images/1.png" alt="WTD" class="img-responsive logoimg" style="position:absolute;top:0px;z-index: 9999;"></a></div>
        <div data-v-0b5d6b6e><div data-v-c0b305c2 data-v-0b5d6b6e class=component-CareersHero><div data-v-c0b305c2 class=bg-container style=left:-321px><div data-v-c0b305c2 class=bg-masker><div data-v-436329e0 data-v-c0b305c2 class=component-image-pre-loader style=width:100vw;height:100%;position:absolute;top:0;left:0><div data-v-b329ee4c data-v-436329e0 tabindex=-1 class=resize-observer><object style=display:block;position:absolute;top:0;left:0;height:100%;width:100%;overflow:hidden;pointer-events:none;z-index:-1 aria-hidden=true tabindex=-1 type=text/html data="data:text/html,<html>" sandbox></object></div> <div data-v-436329e0 class=pre-loader-overlay style=display:none></div> <img data-v-436329e0 src="images/background-tire.jpg" class="contain top-left" style="object-fit:contain;object-position:0 0;background-position:0 0"> </div></div> <svg data-v-c0b305c2 viewBox="0 0 4011 515" preserveAspectRatio="xMinYMid slice" class=hero-mask><defs><path id=a d="M0 0h4011v515H0z" class=path-1></path></defs><g fill=none fill-rule=evenodd><mask id=b fill=#fff><use xlink:href=#a></use></mask><g mask=url(#b)><g transform="translate(0 -437)"><circle stroke=#E1EBF4 stroke-width=529 cx=1283 cy=809 r=809 class=circle style=stroke-dasharray:0,999999px;stroke-dashoffset:5084.1></circle><circle stroke=#FFF stroke-width=529 cx=1283 cy=809 r=809 class=circle-white style=stroke-dasharray:1e-05px,5094.1px;stroke-dashoffset:0></circle><path d="M880.604 437h804.792C1775.771 534.712 1831 665.406 1831 809c0 49.11-6.46 96.711-18.577 142H753.577C741.46 905.711 735 858.11 735 809c0-143.594 55.229-274.288 145.604-372zm-601.167 0C236.473 552.863 213 678.19 213 809c0 48.142 3.18 95.542 9.34 142H0V437h279.437zm2007.126 0H4011v514H2343.66c6.16-46.458 9.34-93.858 9.34-142 0-130.81-23.473-256.137-66.437-372zM1165 437h2846v515H1165V437z" fill=#E1EBF4 fill-rule=nonzero class=path-2></path></g></g></g></svg></div> <div data-v-c0b305c2 class=common-center-container><div data-v-c0b305c2 class=text-container><div data-v-c0b305c2 class=titles-container><div data-v-c0b305c2 class=black><div class=line style=display:block;text-align:right;position:relative;transform:matrix(1,0,0,1,0,0)></div></div> <div data-v-c0b305c2 class=blue><div class=line style=display:block;text-align:right;position:relative;transform:matrix(1,0,0,1,0,0)>WELCOME TO OUR PRIVACY POLICY </div></div></div> <h3 data-v-c0b305c2 class=subheading><div class=line style=display:block;text-align:right;position:relative;transform:matrix(1,0,0,1,0,0)>  </div></h3></div></div></div>

            <div data-v-191b6ba8 data-v-0b5d6b6e class=component-CareersJobs>
                ...
                <div data-v-191b6ba8 class=common-center-container>
                    <div data-v-191b6ba8 class=content-container>
                        <div data-v-191b6ba8 class=jobs-container>
                            ...
                            <p class="paragraf-font-size">WHOLESALE TIRE DISTRIBUTOR, (WTD), is committed to keeping any and all personal information collected of those individuals that visit our website and make use of our online facilities and services accurate, confidential, secure and private. Our privacy policy has been designed and created to ensure those affiliated with WHOLESALE TIRE DISTRIBUTOR of our commitment and realization of our obligation not only to meet but to exceed most existing privacy standards.</p>

                            <p class="paragraf-font-size"><strong>THEREFORE,</strong> this Privacy Policy Agreement shall apply to WHOLESALE TIRE DISTRIBUTOR , and thus it shall govern any and all data collection and usage thereof. Through the use of www.wtdusaonline.com you are herein consenting to the following data procedures expressed within this agreement.</p>

                            <h2 class="paragraf-font-heading">Collection of Information</h2>
                            <p class="paragraf-font-size">This website collects various types of information, such as: </p>
                            <p class="paragraf-font-size"> Information automatically collected when visiting our website, which may include cookies, third party tracking technologies and server logs.</p>
                            <p class="paragraf-font-size">We may also gather information about the type of browser you are using, IP address or type of operating system to assist us in providing and maintaining superior quality service.</p>
                            <p class="paragraf-font-size">It is highly recommended and suggested that you review the privacy policies and statements of any website you choose to use or frequent as a means to better understand the way in which other websites garner, make use of and share information collected.</p>

                            <h2 class="paragraf-font-heading">Use of Information Collected</h2>
                            <p class="paragraf-font-size"><strong> WHOLESALE TIRE DISTRIBUTOR </strong> may collect and may make use of personal information to assist in the operation of our website and to ensure delivery of the services you need and request. At times, we may find it necessary to use personally identifiable information as a means to keep you informed of other possible products and/or services that may be available to you from www.wtdusaonline.com . WHOLESALE TIRE DISTRIBUTOR may also be in contact with you with regards to completing surveys and/or research questionnaires related to your opinion of current or potential future services that may be offered.</p>
                            <p class="paragraf-font-size"><strong> WHOLESALE TIRE DISTRIBUTOR </strong>does not now, nor will it in the future, sell, rent or lease any of our customer lists and/or names to any third parties.</p>
                            <p class="paragraf-font-size"><strong> WHOLESALE TIRE DISTRIBUTOR </strong>may deem it necessary to follow websites and/or pages that our users may frequent in an effort to gleam what types of services and/or products may be the most popular to customers or the general public.</p>
                            <p class="paragraf-font-size"><strong> WHOLESALE TIRE DISTRIBUTOR </strong> may disclose your personal information, without prior notice to you, only if required to do so in accordance with applicable laws and/or in a good faith belief that such action is deemed necessary or is required in an effort to:</p>
                            <p class="paragraf-font-size">Remain in conformance with any decrees, laws and/or statutes or in an effort to comply with any process which may be served upon WHOLESALE TIRE DISTRIBUTOR and/or our website;</p>
                            <p class="paragraf-font-size">Maintain, safeguard and/or preserve all the rights and/or property ofW HOLESALE TIRE DISTRIBUTOR; and</p>
                            <p class="paragraf-font-size"> Perform under demanding conditions in an effort to safeguard the personal safety of users of www.wtdusaonline.com and/or the general public</p>

                            <h2 class="paragraf-font-heading">Children Under Age of 13 </h2>
                            <p class="paragraf-font-size">WHOLESALE TIRE DISTRIBUTOR does not knowingly collect personal identifiable information from children under the age of thirteen (13) without verifiable parental consent. If it is determined that such information has been inadvertently collected on anyone under the age of thirteen (13), we shall immediately take the necessary steps to ensure that such information is deleted from our system's database. Anyone under the age of thirteen (13) must seek and obtain parent or guardian permission to use this website.</p>

                            <h2 class="paragraf-font-heading">Unsubscribe or Opt-Out </h2>
                            <p class="paragraf-font-size">All users and/or visitors to our website have the option to discontinue receiving communication from us and/or reserve the right to discontinue receiving communications by way of email or newsletters. To discontinue or unsubscribe to our website please send an email that you wish to unsubscribe to waseem@wtdusaonline.com. If you wish to unsubscribe or opt-out from any third party websites, you must go to that specific website to unsubscribe and/or opt-out.</p>


                            <h2 class="paragraf-font-heading">Links to Other Web Sites </h2>
                            <p class="paragraf-font-size">Our website does contain links to affiliate and other websites. WHOLESALE TIRE DISTRIBUTOR does not claim nor accept responsibility for any privacy policies, practices and/or procedures of other such websites. Therefore, we encourage all users and visitors to be aware when they leave our website and to read the privacy statements of each and every website that collects personally identifiable information. The aforementioned Privacy Policy Agreement applies only and solely to the information collected by our website.</p>



                            <h2 class="paragraf-font-heading">Security </h2>
                            <p class="paragraf-font-size">WHOLESALE TIRE DISTRIBUTOR shall endeavor and shall take every precaution to maintain adequate physical, procedural and technical security with respect to our offices and information storage facilities so as to prevent any loss, misuse, unauthorized access, disclosure or modification of the user's personal information under our control.</p>
                            <p class="paragraf-font-size">T h e company also uses Secure Socket Layer (SSL) for authentication and private communications in an effort to build users' trust and confidence in the internet and website use by providing simple and secure access and communication of credit card and personal information. In addition, WHOLESALE TIRE DISTRIBUTOR is a licensee of TRUSTe. The website is also secured by VeriSign.</p>


                            <h2 class="paragraf-font-heading">Changes to Privacy Policy Agreement </h2>
                            <p class="paragraf-font-size">WHOLESALE TIRE DISTRIBUTOR reserves the right to update and/or change the terms of our privacy policy, and as such we will post those change to our website homepage at www.wtdusaonline.com, so that our users and/or visitors are always aware of the type of information we collect, how it will be used, and under what circumstances, if any, we may disclose such information. If at any point in time WHOLESALE TIRE DISTRIBUTOR decides to make use of any personally identifiable information on file, in a manner vastly different from that which was stated when this information was initially collected, the user or users shall be promptly notified by email. Users at that time shall have the option as to whether or not to permit the use of their information in this separate manner.</p>
                            



                            <h2 class="paragraf-font-heading">Acceptance of Terms </h2>
                            <p class="paragraf-font-size">Through the use of this website, you are hereby accepting the terms and conditions stipulated within the aforementioned Privacy Policy Agreement. If you are not in agreement with our terms and conditions, then you should refrain from further use of our sites. In addition, your continued use of our website following the posting of any updates or changes to our terms and conditions shall mean that you are in agreement and acceptance of such changes.</p>
                            <h2 class="paragraf-font-heading">How to Contact Us </h2>
                            <p class="paragraf-font-size">If you have any questions or concerns regarding the Privacy Policy Agreement related to our website, please feel free to contact us at the following email, telephone number or mailing address.</p>



                            <h2 class="paragraf-font-heading">Email: <span class="fontspan">help@wtdusaonline.com</span></h2>
                            <h2 class="paragraf-font-heading">Phone: <span class="fontspan">(602) 875 8335</span></h2>
                            <h2 class="paragraf-font-heading">Fax: <span class="fontspan">(602) 875 8408</span></h2>
                            <h2 class="paragraf-font-heading"><strong>Address:</h2>
                            <p class="paragraf-font-size">WHOLESALE TIRE DISTRIBUTOR</p>
                            <p class="paragraf-font-size"> 5137 W Latham St Phoenix, Arizona 85043</p>
                            <!--<p class="paragraf-font-size"> </p>-->
...
<!--                                            <svg data-v-36eb5109 xmlns=http://www.w3.org/2000/svg viewBox="0 0 90 90" style=transform:matrix(1,0,0,1,0,0)>-->
