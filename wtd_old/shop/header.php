...
<body class="language-en"  style="null">
    ...
    <div class="wrapper " id="content">
        <a name="top"></a>
        <div class="header full-left" id="header-full-left">
            ...
            <div class="bottom-header full-left" align="center">
                ...
                <ul class="nav nav-tabs pull-left margin-rgt"> 
                    ...
                    <li class="pull-left button-gap " id="navtab-contactLink" style="padding: 25px 0 0 0px; font-size:11px !important">
                        <span class="link-name" style=""><?=$_SESSION['email']?></span>
                    </li>
                </ul> 
