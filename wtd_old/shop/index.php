                            ...
                            if (!empty($rw)) {
                                ...
                                <div class="item <?php echo $check ?>">
                                  <div class="col-md-2 col-sm-6 col-xs-12" id="bimg<?=$rowW->id?>">
                                        <img src="<?php echo $rowW->feature_img ?>" alt="" class="img-responsive wimg<?=$rowW->id?>" id="<?=$rowW->catalog?>" onclick="changeImage(<?php echo $rowW->id ?>)" style="">
                                    </div>
                                </div>
                                <?php
                                $check = "";
            ...
            <div id="wowslider-container3">
                <div class="ws_images">
                    <ul>
                        ...
                        ?>
                        <li><img src="../admin/<?=$row->slider_images?>" alt="<?=$row->title?>" title="<?=$row->title?>" id="wows3_<?=$count?>"/>
...
function changeImage(id) {
    ...
    $.ajax({
        ...
        success:function(response){
            $("#bimg"+id).html('<a href="products.php?search=Search='+catalog+'"><img src="'+imgsrc+'" alt="" class="img-responsive" style="opacity:0.7"></a>');
            // alert(response);
